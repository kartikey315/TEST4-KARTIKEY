      ...
      <div className="bg-black border-gray-800 border-2 text-white p-6 sm:p-8 max-w-[80%] min-h-[90%] rounded-lg shadow-md">
          ...
          <div className="flex justify-center gap-2 mb-6">
            {passcode.map((digit, index) => (
              <input
                ...
                type="password"
                className="bg-black border border-gray-600 w-10 sm:w-14 h-10 sm:h-14 text-center text-2xl rounded-md"
                maxLength={1}
                value={digit}
        ...
        <div>
          <div className="flex justify-center max-w-[100%]">
            <div className="flex flex-col sm:flex-row justify-between min-w-[60%] items-center">
              <BiometricLoginWidget
                setCurrentLoginMethod={setCurrentLoginMethod}
              />
              <div className="border-l-2 hidden sm:block border-gray-800 sm:min-h-[40vh] mx-10 mr-32 text-black"></div>
              <SocialLoginWidget
                setCurrentLoginMethod={setCurrentLoginMethod}
              />
            </div>
